...
if __name__ == "__main__":
    ...
    x_data_test = np.concatenate((
        ...
        np.log(x_data_test[:, 0] * x_data_test[:, 1] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 0] * x_data_test[:, 2] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 0] * x_data_test[:, 4] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 0] * x_data_test[:, 5] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 0] * x_data_test[:, 6] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 1] * x_data_test[:, 2] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 1] * x_data_test[:, 4] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 1] * x_data_test[:, 5] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 1] * x_data_test[:, 6] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 2] * x_data_test[:, 4] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 2] * x_data_test[:, 5] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 2] * x_data_test[:, 6] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 4] * x_data_test[:, 5] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 4] * x_data_test[:, 6] + 1e-10).reshape((-1, 1)),
        np.log(x_data_test[:, 5] * x_data_test[:, 6] + 1e-10).reshape((-1, 1))),
        axis = 1)
