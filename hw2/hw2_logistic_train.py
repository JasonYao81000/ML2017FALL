...
if __name__ == "__main__":
    ...
    np.save('logistic_std.npy', x_data_train_std)
    np.save('logistic_mean.npy', x_data_train_mean)
    ...
    np.save('logistic_model.npy', w)
    # Save weights to csv file.
    np.savetxt('logistic_weights.csv', w, delimiter = ',')